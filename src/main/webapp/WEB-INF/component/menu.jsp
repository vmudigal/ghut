...
<div class="tabbable tabs-left" style="border-right:2px solid black;" >
	<ul class="nav nav-list">
		...
		<li style="margin-bottom: 25px;margin-top: 12px;"><a href="<c:url value="/hwf" /> "><img width="80%" style="max-width: 80px;" src="https://lh5.ggpht.com/d1wGiWgLfWRacryVQp1jIBSaEOmiltFbvleNCTROWTBd39z_IOj6ioVGG1qQLhXgXXWP=w124" /><br/>Hanging</a></li>
	</ul>
</div>